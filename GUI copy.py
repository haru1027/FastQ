...
username_label = Label(entrysection,text='Student ID',font=('poppins',15),bg='white')
username_label.grid(row=1,columnspan=2,sticky='w')
...
def register():
     frame.grid_remove()
     regframe = Frame(window,border=2,relief=SUNKEN,background='white',padx=300)
     regframe.grid()

     create = Label(regframe,text="Create new account",font=('poppins',20),fg='Black',bg='White',padx=10,pady=140,image=User_icon,compound='left')
